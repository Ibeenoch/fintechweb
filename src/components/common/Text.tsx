...
export default function Text({
  ...
  return (
    <div>
      {fontSize === "extrahuge" ? (
        <h1 className={`text-[30px] sm:text-[54px] ${classNames} `}>{text}</h1>
      ) : fontSize === "huge" ? (
        <h2 className={`text-[28px] sm:text-[48px] ${classNames} `}>{text}</h2>
      ) : fontSize === "extraLarge" ? (
        <h3 className={`text-[24px] sm:text-[38px] ${classNames} `}>{text} </h3>
      ) : fontSize === "large" ? (
        <h4 className={`text-[20px] sm:text-[28px] ${classNames} `}>{text}</h4>
      ) : fontSize === "medium" ? (
